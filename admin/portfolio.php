    ...
    <script>
        function del(Id){
            if(confirm("If you want to Delete it?")){
                window.location.assign("portfolio.php?Id="+Id);
            }
        }
    </script>
    <?php
...
<body>
    ...
    <section class="my-4">
        <div class="container">
            <form action="portfolio.php" method="POST" enctype="multipart/form-data" class="border rounded p-4 d-flex flex-column gap-2">
                <h2>Portfolio Details</h2>
                <input type="number" placeholder="Category Id" class="form-control" name="categoryid" required>
                <input type="text" placeholder="Portfolio Title" class="form-control" name="title" required>
                <input type="text" placeholder="Portfolio Author" class="form-control" name="author" required>
    ...
    <?php
          ...
          if(isset($_POST['submit']) && !empty($_FILES['file']['name'])){
            ...
            $format=["jpg","png","JPG","gif","doc","ppt","txt","pdf","html","php"];
            ...
            if(in_array($fileextensionoffile,$format)){
              ...
              if(in_array($fileextensionoffileimage,$format))
                ...
                $sql="insert into portfolio(title,author,image,price,description,released_date,filepath,category_id) 
    ...
    <tr>
        ...
        <td><?php echo $portfolioid ?></td>
        <td><?php echo $title ?></td>
        <td><?php echo $author ?></td>
        <td><a href="assets/portfolio/<?php echo $file ?>"><?php echo $file ?></a></td>
        <td><img src="assets/portfolio/<?php echo $image ?>" class="img-fluid" width="100" height="60"><small><?php echo $image ?></small></td>
        ...
        <td>
            ...
            <button class="btn btn-danger" onclick="del(<?php echo $portfolioid ?>)">Delete</button>
        </td>
    </tr>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
                ...
                <input type="number" placeholder="Id" class="form-control" name="portfolioid" id="portfolioid" readonly>
...
<?php
    ...
    if(isset($_POST['update'])){
        ...
        $directorytostore="assets/portfolio/";
        ...
        if(!empty($_FILES['changedfile']['name'])){
            ...
            $allowed=["pdf","doc","docx","ppt","html","php"];
         ...
         if(!empty($_FILES['changedimage']['name'])){
            ...
            $allowed=["jpg","png","JPG","jpeg","gif","html","php"];
        ...
        $sql="update portfolio set title='{$title}',author='{$author}',image='{$currentimage}',price={$price},
                          description='{$description}',released_date='{$date}',filepath='{$currentfile}' where portfolio_id={$portfolioid}";
